...
def process_markdown_with_ocr(md_path):
    ...
    for i, (alt, img_path) in enumerate(images, 1):
        ...
        results.append({"alt": alt, "path": img_path, "text": text})
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        ...
        f.write("## Notes\n\n")
        f.write(
            "*Review the extracted text above and process into appropriate lists or memos:*\n\n"
        )
...
def main():
    if len(sys.argv) != 2:
        print(
            "Usage: python3 .2ndBrain/skills/ocr-images.py <markdown-file>",
            file=sys.stderr,
        )
        print("\nExample:")
